...
ActiveRecord::Schema.define(version: 2019_10_20_124934) do
  ...
  create_table "broadcasts", force: :cascade do |t|
    ...
    t.index ["label", "details", "people"], name: "index_broadcasts_on_label_and_details_and_people", opclass: :gin_trgm_ops, using: :gin
  ...
  create_table "tracks", force: :cascade do |t|
    ...
    t.index ["artist", "title"], name: "index_tracks_on_artist_and_title", opclass: :gin_trgm_ops, using: :gin
