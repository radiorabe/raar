...
class AuthorizationTest < ActionDispatch::IntegrationTest
  ...
  test 'POST create user as REMOTE USER with json body creates REMOTE_USER and adds passed user' do
  ...
  test 'POST create user with HTTP TOKEN with json body adds new user' do
